...
For this portfolio, do not turn Forget-Me-Graph into a shared shell or minor reskin of another entry. Its subject-deletion workflow, implementation, repository, demo, and claims must stand on their own.
...
## Forget-Me-Graph scoring checklist

- [ ] DataHub shows end-to-end data-to-model or data-to-RAG lineage.
- [ ] A real subject selector propagates through explicit key mappings.
- [ ] Purge, rebuild, and toy retraining actions genuinely execute.
- [ ] Raw personal data is not exposed to the LLM.
- [ ] Verification distinguishes complete, failed, blocked, and out-of-scope assets.
- [ ] The evidence certificate corresponds exactly to recorded actions.
- [ ] Results are written back to DataHub.
- [ ] The README avoids claiming a universal machine-unlearning algorithm.
